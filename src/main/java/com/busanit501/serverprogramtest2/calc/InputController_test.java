package com.busanit501.serverprogramtest2.calc;
...
@WebServlet(name = "inputController", urlPatterns = "/calc/input_test")
public class InputController_test extends HttpServlet {
    // get : 폼화면을 그려준다.
...
//    super.doGet(req, resp);
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("/WEB-INF/calc/input_test.jsp");
        // 역할:, 해당 뷰페이지로 전달하기.
        // 서버 -> 브라우저에게 정보를 제공
...
//    super.doPost(req, resp);
        ...
        String num1 = req.getParameter("menu");
